      ...
      return (
            <div className='w-full p-2 flex flex-col gap-4'>
                  <div className='w-full flex items-center justify-around gap-4'>
                        <select className='px-8 py-4 text-2xl font-kameron border border-gray-300'>
                        ...
                        <select className='px-8 py-4 text-2xl font-kameron border border-gray-300'>
                              ...
                              <option value='pincode1'>123456</option>
                              <option value='pincode2'>654321</option>
                              <option value='pincode3'>789101</option>
                              {/* Add more pincodes as needed */}
                        </select>
                  </div>
                  <div className='w-full flex justify-between'>
                        <div className='w-[25%] h-[33rem] bg-white py-4 px-2 flex justify-around flex-col '>
                              <div>
                                    <h1 className='font-kameron font-semibold'>TOTAL DWLRs</h1>
                                    <div className='w-full flex items-center justify-center'>
                                          <h1 className='text-5xl font-kameron font-semibold'>550</h1>
                                    </div>
                              </div>
                              <div>
                                    <h1 className='font-kameron font-semibold'>ACTIVE DWLRs</h1>
                                    <div className='w-full flex items-center justify-center'>
                                          <h1 className='text-5xl font-kameron font-semibold'>550</h1>
                                    </div>
                              </div>
                              <div>
                                    <h1 className='font-kameron font-semibold'>Problematic DWLRs</h1>
                                    <div className='w-full flex items-center justify-center'>
                                          <h1 className='text-5xl font-kameron font-semibold'>550</h1>
                                    </div>
                              </div>
                              <div>
                                    <h1 className='font-kameron font-semibold'>Low Battery</h1>
                                    <div className='w-full flex items-center justify-center'>
                                          <h1 className='text-5xl font-kameron font-semibold'>550</h1>
                                    </div>
                              </div>
                        ...
                        <div className='w-[30%] h-[33rem]  flex flex-col justify-between'>
                              <div className='w-full h-[49%] bg-white p-2'>
                                    <div className='flex justify-between items-center'>
                                          <div className='text-sm font-kameron'>
                                                <h3>State Name</h3>
                                                <h3>City Name</h3>
                                          </div>
                                          <div className='flex gap-2'>
                                                <button onClick={() => setChartType('pie')} className='bg-[#DEFFFC] text-[#FED766] py-1 px-2 rounded-md text-sm font-kameron'>pie</button>
                                                <button onClick={() => setChartType('bar')} className='bg-[#DEFFFC] text-[#FED766] py-1 px-2 rounded-md text-sm font-kameron'>bar</button>
                                          </div>
                                    </div>
                                    <div>
