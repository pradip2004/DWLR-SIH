...
const CurrentWater = ({ data, loading, id }) => {
  ...
  return (
    <div className="current overflow-y-scroll w-1/2 h-full bg-white rounded-md shadow-lg p-5">
            ...
            <div className="w-[15vw] bg-gray-50 rounded-lg shadow-md p-4">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-center">
                  ...
                  <p className="font-semibold text-lg text-[#F44336]">{lowestWaterLevel}0</p>
                </div>
              </div>
...
//   const [selectedDate, setSelectedDate] = useState("Previous 10 days");
